...
extern cm_timer cm_timer1, cm_timer2, cm_timer3, cm_timer4, cm_timer5, cm_timer6;
extern int cm_counter1, cm_counter2, cm_counter3;
...
extern unsigned int cm_nt_binomial (unsigned int n, unsigned int k);
